...
from services.weather.infrastructure.handlers.openweather_handler import (
    ensure_api_key,
    process_openweather_response,
)


class OpenWeatherClient:
    """Client for accessing OpenWeatherMap current weather data."""
    ...
    async def get_current_weather(self, city: str):
        ...
        Returns tuple: (city_name, temperature_celsius,
        description, humidity_percent, wind_speed_mps)
        """
